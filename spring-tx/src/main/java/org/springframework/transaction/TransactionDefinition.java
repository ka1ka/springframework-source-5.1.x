...
public interface TransactionDefinition {
	 ...
	 * 任何的异常抛出时，所有的操作都会回滚.
	 *
	 * @Transctional public void service() {
	 * service1();
	 * service2();
	 * }
	 ...
	 *
	 * @Transactional(propagation=Propagation.SUPPORTS) service1() {}
	 * <p>
	 * <p>
	 ...
	 * }
	 *
	 * @Transactional(propagation=Propagation.MANDATORY) service2() {
	 * executeUpdate(sql);
	 * }
	 */
	 ...
	 *
	 * @Transactional public void service() {
	 * service1();
	 * try {
	 * service2();
	 * } catch(Exception e) {}
	 ...
	 * executeUpdate(sql);
	 * }
	 * @Transactional(propagation=Propagation.NOT_SUPPORTED) service2() {
	 * executeUpdate(sql1);
	 * int i = 1 / 0;
	 * executeUpdate(sql2);
	 * }
	 ...
	 * }
	 *
	 * @Transactional(propagation=Propagation.NEVER) service2() {
	 * executeUpdate(sql1);
	 * int i = 1 / 0;
	 * executeUpdate(sql2);
	 * }
	 ...
	 * executeUpdate(sql);
	 * }
	 * @Transactional(propagation=Propagation.NESTED) service2() {
	 * executeUpdate(sql1);
	 * int i = 1 / 0;
	 * executeUpdate(sql2);
	 * }
